...
def main():
    ...
    print("Story: Mamba-kun is at position 0.0 and decides to accelerate towards the target (10.0).")
    ...
    for i in range(10):
        ...
        print(f"Step {i+1:2d}: [Imagined] Pos: {pred_pos:5.2f}, Vel: {pred_vel:5.2f}, Distance: {pred_dist:5.2f}, Reward: {reward.item():.4f}")
